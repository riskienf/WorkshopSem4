                ...
                <div class="white-box">
                    ...
                    <table class="table table-xl-responsive mt-4" id="data_table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="text-center pt-4">{{ $item->product_code }}</td>
                                <td>
                                ...
                                <td class="text-center">{{ $item->stock }} biji</td>
                                <td class="text-right">Rp{{ number_format($item->price, 2, ',', '.') }}</td>
                                <td>
                                    <div class="d-flex justify-content-center">
                                        <div class="form-inline p-0">
                                            <a href="{{ route('product.edit', $item->product_code) }}" class="btn btn-success mr-2" title="Edit" data-toggle="tooltip"> <span class="fa fa-pen"></span> </a>
                                            <form action="{{ route('product.destroy', $item->product_code) }}" method="post">
                                                @csrf
                                                @method('delete')
