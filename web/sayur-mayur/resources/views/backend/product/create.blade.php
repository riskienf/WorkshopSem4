                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="formProduk" name="product_code" value="{{ $product_code }}" placeholder="ex : CC001" value="{{ old('product_code') }}" readonly>
                                    @error('product_code')
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="supplier_code" id="formSupplier" class="form-control">
                                        ...
                                        @foreach ($supplier_code as $item)
                                            <option value="{{ $item->supplier_code }}">{{ $item->supplier_code }} - {{ $item->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('supplier_code')
                                    <p class="text-danger">{{ $message }}</p>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="formPrice" name="price" placeholder="ex : 3,000.00" value="{{ old('price') }}">
                                    @error('price')
                                    <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="formSellPrice" name="sell_price" placeholder="ex : 7,000.00" value="{{ old('sell_price') }}">
                                    @error('sell_price')
                                    <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
