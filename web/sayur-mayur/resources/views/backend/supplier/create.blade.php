        ...
        <div class="row">
            <div class="col-md-12">
                <div class="white-box">
                    ...
                    <form class="mt-4" action="{{ route('supplier.store') }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    <label for="formSupplier">Kode Suplier</label><span class="text-danger">*</span>
                                    <input type="text" class="form-control" id="formSupplier" name="supplier_code" value="{{ $supplier_code }}" placeholder="ex : SC001" value="{{ old('supplier_code') }}" readonly>
                                    @error('supplier_code')
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <textarea name="address" id="formAddress" class="form-control" cols="30" rows="3">{{ old('address') }}</textarea>
                                    @error('address')
                                    <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
